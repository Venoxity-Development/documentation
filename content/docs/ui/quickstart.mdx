...
Run the app in development mode and open [http://localhost:3000/docs/ui](http://localhost:3000/docs/ui) in your browser.
...
<Card title="Add Content With MDX" icon={<FileIcon />} href="/docs/ui/essentials/markdown">
  Add content to your docs with MDX syntax.
</Card>

<Card title="Add Code Blocks" icon={<CodeIcon />} href="/docs/ui/essentials/code">
