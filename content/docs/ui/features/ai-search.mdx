...
## Introduction
Fumadocs comes with built-in AI-powered search capabilities. Although this feature is enabled by default, you’ll need to configure an API key for full functionality.
