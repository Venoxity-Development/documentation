---
description: >-
  A user-friendly plugin that adds a built-in emote menu and smooth animation
  controls to Grand Theft Auto V, making player expression quick and immersive.
icon: person
